...
## Export NLDAS grid
In this week's silly exercise, I manually optimized a buffer on my gmd4+ buffered study region in order to have the boundary polygon cover all centroids of nldas grid cells in order to pull everything through on the crop/mask.
