...
```{r writeExpts}
# output directory
OutDir <- 'E:/Jill/salusExperiments/lema_historic_auto_v01'
...
```{r hpccSh}
xdbDir <- 'E:/Jill/salusExperiments/lema_historic_auto_v01'
outDir <- xdbDir
...
fileOut <- paste0(outDir, '/LEMA_hist_auto_v01.bat')
