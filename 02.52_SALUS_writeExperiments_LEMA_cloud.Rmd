...
cropParamKey <- data.frame(crop = c('CORN','SOYBEANS','WHEAT','SORGHUM','GRASS',
                           ...
                           Ppop_rain = c('3', '39.54', '494.21', '8.6', '50', '5'),
...
# output directory
OutDir <- 'E:/Jill/salusExperiments/lema_historic_auto_v02'
...
xdbDir <- 'E:/Jill/salusExperiments/lema_historic_auto_v02'
outDir <- xdbDir
