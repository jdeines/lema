...
I think I will break this up into 4 functions:

* write_xdb_topMatter
* write_xdb_experiment
* write_xdb_rotation (with argument for being the last rotation = closes out Experiment)
...
Writes the Rotation arguments. This section has an argument for first/last rotation component to optionally include the beginning `<Rotation_Components>` start tag or the end tags for rotation and experiment.
...
# optional - default argument is 'middle'
postition <- 'middle' # default; options = 'first' and 'last' 


write_xdb_rotation <- function(outFile, OrderNum, Title, irrig, fertilize, tillage,
                               harvest, position = 'middle'){
...
write_xdb_experiment(outFile, ExpID, RunTitle, startYear, endYear, startDOY,
                     WthID, WthFile, SoilID, SoilFile, CropFile)
write_xdb_rotation(outFile, OrderNum, Title, irrig, fertilize, tillage,
