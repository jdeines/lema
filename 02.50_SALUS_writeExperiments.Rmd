...
annualSpecs <- wheatDates %>%
  select(c('year','crop','plantingDOY_50','harvestedDOY_50')) %>%
...
outFile <- 'C:/Users/deinesji/Dropbox/1PhdJill/hpa/LEMAs/SALUS/testGUIrun/lemaWheatContinuous/lema_wheat_continuous.xdb.xml'
...
for(i in 1:nrow(exp_master)){  
  ...
  write_xdb_experiment(outFile, exp_master$ExpID[i], exp_master$runTitle[i], 
