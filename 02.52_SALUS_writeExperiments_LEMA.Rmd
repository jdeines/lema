...
cropParamKey <- data.frame(crop = c('CORN','SOYBEANS','WHEAT','SORGHUM','GRASS',
                           ...
                           Ppop_rain = c('4', '39.54', '494.21', '8.6', '50', ''),
                           Ppop_irr = c('7.5', '39.54', '494.21', '8.6', '50', ''),
                           RowSpc = c('76', '54', '19.05','50.8', '20', ''),
...
for(i in 1:nrow(exp_master)){  
  ...
  for(m in 1:nrow(annualSpecs)){
    ...
    if (annualSpecs$irrStatus[m] == 1) irrig <- 'F'; ppopCol <- 'Ppop_irr'
    if (annualSpecs$irrStatus[m] == 0) irrig <- 'N'; ppopCol <- 'Ppop_rain'
