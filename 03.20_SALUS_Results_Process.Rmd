...
knitr::opts_chunk$set(echo = TRUE, fig.path='figure/03.20_4_salus_results_process/',
...
resultsDir <- 'C:/Users/deinesji/Dropbox/1PhdJill/hpa/LEMAs/data/salus/experiments/4_LEMA_hist_fixed_v02/results'
# subfolder for maps output
subf <- 'maps'

# run name
runname <- '4_lema_historic_fixed_v02'
...
irrStack <- spatializeAll(expt.annual, 'IRRC_mm', yearsWanted, gridExps,
                          template, aoi, writeOut = 'Y', outFolder = outdir)
